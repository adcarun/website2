...
<div id="carousel-example-generic-event" class="carousel slide" data-ride="carousel">
  <!-- Indicators -->
  <ol class="carousel-indicators">
	<?php $cntInd=0; foreach ($items as $key=>$item):	?>
    <li data-target="#carousel-example-generic-event" data-slide-to="<?php echo $cntInd; ?>" <?php if($cntInd==0){ ?> class="active" <?php } ?>></li>
