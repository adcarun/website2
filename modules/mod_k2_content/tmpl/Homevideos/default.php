...
<?php if(count($items)): ?>
<div class="col-lg-6 col-md-4 col-sm-12 col-xs-12 info-boxes">
                	<div class="info-box-carousel">
                    	
                        
                        <div id="videoCarousel" class="videoCarousel thumbnailCarousel carousel slide" data-ride="carousel">
                          
                          <!-- Wrapper for slides -->
                          <div class="carousel-inner" role="listbox">
						  <?php $cnt=0; foreach ($items as $key=>$item):	?>
                            <div class="item <?php if($cnt==0){ ?>active<?php } ?>">
                              <a href="#" data-toggle="modal" data-target="#videoModal<?php echo $item->id; ?>">
...
<!-- Modal -->
<?php $cntModal=0; foreach ($items as $key=>$itemModal):	?>
    <div class="videoModal modal fade" id="videoModal<?php echo $itemModal->id; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-body">
          	<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            <?php echo $itemModal->introtext; ?>
          </div>
        </div>
      </div>
    </div>
<?php $cntModal++; endforeach; ?>
