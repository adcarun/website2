            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="text-center">
                        <h2 class="heading">Placements</h2>
                    </div>
    
                    <div id="placementCarousel" class="carousel thumbnailCarousel slide" data-ride="carousel">
                        <!-- Indicators -->
                        <!--<ol class="carousel-indicators">
                        <li data-target="#placementCarousel" data-slide-to="0" class="active"></li>
                        <li data-target="#placementCarousel" data-slide-to="1"></li>
                      </ol>-->
                            ...
                            <div class="item active">
                                <div class="row">
                                    ...
                                    <?php if($params->get('itemImage')){ ?>
										<img src="<?php echo $item->image; ?>" alt="<?php echo K2HelperUtilities::cleanHtml($item->title); ?>" title="<?php echo K2HelperUtilities::cleanHtml($item->title); ?>" class="img-responsive">
									<?php } ?>
									</div>
									<?php  
										$cnt++;
										if($cnt%5==0 && $cnt != count($items)){ ?>
										</div></div>
										<div class="item">
											<div class="row">
									<?php } ?>
                        ...
                        <div class="text-center" style="margin-top: 20px;">
                            <a class="left carousel-control" href="#placementCarousel" role="button" data-slide="prev">
                                <i class="fa fa-long-arrow-left" aria-hidden="true"></i>
                                <span class="sr-only">Previous</span>
                            </a>
                            <a class="right carousel-control" href="#placementCarousel" role="button" data-slide="next">
...
<?php/*<div id="k2ModuleBox<?php echo $module->id; ?>" class="k2ItemsBlock<?php if($params->get('moduleclass_sfx')) echo ' '.$params->get('moduleclass_sfx'); ?>">
