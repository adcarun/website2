...
<div class="newsletter dark-blue">
        <h4 class="text-uppercase"><?php echo $module->title; ?></h4>
        <div id="student-testimonial-carousel" class="thumbnailCarousel carousel slide" data-ride="carousel">
        
          <!-- Wrapper for slides -->
          <div class="carousel-inner" role="listbox">
		  <?php if(count($items)): ?>
			<?php $cnt=1; foreach ($items as $key=>$item):	?>	
            <div class="item <?php if($cnt==1){ ?> active<?php } ?>">
              <p><?php echo $item->introtext; ?></p>
              <h4><?php echo K2HelperUtilities::cleanHtml($item->title); ?> </h4>
            </div>
			<?php $cnt++; endforeach; ?>
		...
		<?php endif; ?>	
		  ...
		  <?php if(count($items)): ?>
          <div class="">
              <a class="left carousel-control" href="#student-testimonial-carousel" role="button" data-slide="prev">
                <span class="glyphicon glyphicon-menu-left" aria-hidden="true"></span>
                <span class="sr-only">Previous</span>
              </a>
              <a class="right carousel-control" href="#student-testimonial-carousel" role="button" data-slide="next">
