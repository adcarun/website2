...
<div class="col-md-4 col-sm-12 col-xs-12">
                    ...
                    <h2 class="heading"><?php echo $module->title; ?></h2>
                    <?php if(count($items)): ?>
					<!--<marquee scrollamount="infinite" onmouseover="this.stop();" onmouseout="this.start();" direction="up" scrolldelay="150" height="200px">-->
					<?php foreach ($items as $key=>$item): //print_r($item);	
					//echo $item->tags[0]->name;?>
                    <div class="media latestNewsMedia">
                      <div class="media-left">
                        <div class="date">
							<?php 
								$creatednew=$item->created;
								$dNew= date("d", strtotime($creatednew));
								$mNew= date("M", strtotime($creatednew));
							?>
                        	<?php echo $dNew; ?><span style="text-transform:uppercase"><?php echo $mNew; ?></span>
                        </div>
                      </div>
                      <div class="media-body">
					  <?php if($item->tags[0]->name=='new'){ ?><span style="text-decoration: blink;float:right;color:red;font-size:14px"><img src='/images/New.png' /></span><?php } ?>
                        <p><?php echo K2HelperUtilities::cleanHtml(substr($item->title,0,80))." ..."; ?> <a href="<?php echo $item->link; ?>">Read More..</a></p>
                      </div>
                    </div>
					<?php endforeach; ?>
					<!--</marquee>-->
					<?php endif; ?>
					<br />
                    <a href="index.php/news" class="btn btn-default">View All</a>
