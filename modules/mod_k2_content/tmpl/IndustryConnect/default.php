...
<div class="col-md-3 col-sm-4 col-xs-12 technologyBox">
          <div class="technologyBoxIn"> <img src="<?php echo $item->image; ?>">
            <h4>  <?php echo $item->title; ?></h4>
            <div class="technologyBoxText">              
              <p><?php echo $item->introtext; ?></p>
            </div>
            <a class="readMore" href="<?php echo $item->link; ?>">Read more</a> </div>
</div>
