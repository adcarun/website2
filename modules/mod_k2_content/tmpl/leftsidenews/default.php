...
<div class="news dark-blue">
        <h4><?php echo $module->title; ?></h4>
		  <?php if(count($items)): ?>
		<?php foreach ($items as $key=>$item):	?>
        <div class="newsMedia">
            <h5><a href="<?php echo $item->link; ?>"><?php echo K2HelperUtilities::cleanHtml($item->title); ?></a></h5>
            <h5><span>
			<?php 
								$creatednew=$item->created;
								$dNew= date("d", strtotime($creatednew));
								$mNew= date("M", strtotime($creatednew));
								$yNew= date("Y", strtotime($creatednew));
								echo $dNew."-".$mNew."-".$yNew;
							?>
			</span></h5>
        </div>
        ...
        <!--  <div class="newsMedia">
                  <h5><a href="#">Inauguration of " National Conference on Emerging Trends in Advanced Communication Technologies (NCETACT-15)</a></h5>
                  <h5><span>09-Jan-2015</span></h5>
                 </div>

                 <div class="newsMedia">
                  <h5><a href="#">FDP on "Professional Advancement of Engineering Faculty" for all teaching faculty was conducted</a></h5>
                  <h5><span>09-Dec-2015</span></h5>
                 </div>-->
        <a href="index.php/news" class="more-news">More News<span class="glyphicon glyphicon-circle-arrow-right" aria-hidden="true"></span></a>
    </div>
