...
<section class="students-say-container">
  	<div class="container">
    	<div class="row">
        	<div class="col-md-6">
            	<h2><?php 
					$values=explode(" ",$module->title); 
					$i=0;
					echo "<span>";	
            ...
            <div class="col-md-6">
            	...
            	<div id="testimonial-carousel" class="testimonial-carousel carousel slide" data-ride="carousel">
                  <!-- Indicators -->
				  ...
				  <?php  $cnt=0; foreach ($items as $key=>$item):	
						 $vals=json_decode($item->extra_fields); //print_r($vals);
				  ?> 
                    <div class="item <?php if($cnt==0){?>active<?php } ?>">
                       <p><?php echo $item->introtext; ?></p>
						<h4><?php echo $item->title; ?> <?php if($vals[1]->value !=""){ ?><span><?php echo $vals[1]->value; ?></span><?php } ?></h4>
						<?php if($vals[0]->value !=""){ ?>
							<img src="<?php echo JURI::root().$vals[0]->value; ?>" alt="<?php echo K2HelperUtilities::cleanHtml($item->title); ?>" title="<?php echo K2HelperUtilities::cleanHtml($item->title); ?>" width="50">
						<?php } ?>
                    </div>
					<?php $cnt++; endforeach; ?>                  
                  </div>
