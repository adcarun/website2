...
<?php foreach ($items as $key=>$item):	?>
 <div class="mapContact <?php if($item->title=='India'){ ?>mapContactIndia<?php } ?>">
    
                    <!-- <span class="fa fa-mobile" aria-hidden="true"></span> -->
                    <div class="flag">
						 <?php $vals=json_decode($item->extra_fields); //print_r($vals); ?>
						 
                        <img src="<?php if($vals[0]->value !=""){ ?><?php echo JURI::root().$vals[0]->value; ?><?php } ?>" alt="<?php echo K2HelperUtilities::cleanHtml($item->title); ?>"  width="20" height="20" alt="">
                        <span class="Number">
