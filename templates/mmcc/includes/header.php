        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="<?php echo $this->baseurl; ?>" title="Marathwada Mitramandal's College of Commerce">
            ...
            <span>
                ...
                <span class="tagline">
				<b>202/A Deccan Gymkhana, Pune 411004</b><br/>
		  ...
		  <?php $cntMain=0; foreach($dataMainMenu as $MainMenudata){ 
			...
			?>
              ...
              <a href="<?php if($MainMenudata->type=="url"){ echo $MainMenudata->link; }elseif($MainMenudata->type=="alias"){ 
								...
								}else{ echo $this->baseurl."/index.php/".$MainMenudata->path; } ?>" class="dropdown-toggle" ><?php echo $MainMenudata->title; ?>  </a><i class="fa fa-angle-down" aria-hidden="true" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"></i>
								<!--data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"-->
              <div class="dropdown-menu <?php if($cntMain >=5){ ?>dropdown-menu-right<?php } ?>">
                <?php /*?><div class="row"><?php */?>
				<?php /*?><div <?php if(count($dataMainMenusub) > 4){ ?>class="col col-sm-6"<?php }else{ ?>class="col col-sm-12"<?php } ?>><?php */?><ul>
