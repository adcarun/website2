...
<div class="catItemView group<?php echo ucfirst($this->item->itemGroup); ?><?php echo ($this->item->featured) ? ' catItemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>" style="margin-bottom:0px">
	...
	<div class="catItemHeader">
		...
		<?php foreach ($this->item->extra_fields as $key=>$extraField): ?>
			<?php //print_r($extraField); 
				if($extraField->name=="StudentImage"){
	  ...
	  <h3 class="catItemTitle">
		...
		<?php foreach ($this->item->extra_fields as $key=>$extraField): ?>
			<?php //print_r($extraField); 
				if($extraField->name=="Designation"){
					echo "- <span style='font-size:16px;'>".$extraField->value."</span>";
				}
			?>
